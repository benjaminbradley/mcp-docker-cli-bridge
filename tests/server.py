...
def _filter_schema_properties() -> dict:
    return {
        "pipe": {
            "type": "string",
            "description": (
...
def _create_tool_handler(name: str, commands: CommandsConfig, log_dir: str, log_file: str):
...
@asynccontextmanager
async def _cache_cleanup_lifespan(server):
